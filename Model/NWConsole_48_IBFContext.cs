...
{
    public partial class NWConsole_48_IBFContext : DbContext
    {
        public NWConsole_48_IBFContext()
        {
        }

        public NWConsole_48_IBFContext(DbContextOptions<NWConsole_48_IBFContext> options)
            : base(options)
        {
        }
